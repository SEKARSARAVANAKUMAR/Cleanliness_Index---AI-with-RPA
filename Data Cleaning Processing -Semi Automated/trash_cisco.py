...
z=a[(a.devicetype.str.contains('trash'))]
...
for index,rows in z.iterrows():
    ...
    try:
        ...
        print("check the date_Time range calculation function")
    try:
        pr1=fetch_.date_time_operation(df)
        pr2=fetch_.trash_clean(pr1)
        Final=fetch_.Trash_Usage_Calculation(pr2)
        ...
        Gigar_3=fetch_.optimize_smoothed_error_count_trash(Gigar_2)
        Gigar_4=fetch_.Trash_Usage_Calculation_optimize(Gigar_3)
        #Gigar_5=Final_clean(Gigar_3)
    except:
    ...
    try:
        ...
        result_.smoothed_value=np.where(result_.smoothed_value > 150,0,result_.smoothed_value)
    ...
    try:
        ...
        #result_.to_sql(con=database_connection, name='trash_bin_batch', if_exists='append',index=False)
        result_1=result_[result_.date <= '2019-07-31']
        result_2=result_[result_.date > '2019-07-31']
        result_1.to_sql(con=database_connection, name='trash_bin_batch', if_exists='append',index=False)
        result_2.to_sql(con=database_connection, name='trash_bin_batch', if_exists='append',index=False)
    except:
        print("check the trash data final db format")
    #data_ass
    try:
        ...
        print("print data asssesment Part")
db.close()
dbe.close()
#tlt_ass.to_csv('C:\\Users\\saravanan\\Desktop\\client_details_cleanliness_index_trash.csv',index=False)
#tlt_ass_dev.to_csv('C:\\Users\\saravanan\\Desktop\\client_details_cleanliness_index_trash_device.csv',index=False)
