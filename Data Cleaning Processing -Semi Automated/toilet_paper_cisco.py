...
dbe = pymysql.connect("****", "****", "****", "****")
try:
    query1="select * from sample_client_details where clientid ="+s_cn+" and areaid not in (160,162,171,172);"
...
z=a[(a.devicetype.str.contains('toiletPaper'))]
...
for index,rows in z.iterrows():
    ...
    try:
        ...
        Final=fetch_.toilet_paper_usage_calculation(pr2,R)
        ...
        Gigar_4=fetch_.toilet_paper_usage_calculation_optimize(Gigar_3,R)
    ...
    try:
        ...
        #result_.to_sql(con=database_connection, name='toilet_paper_batch', if_exists='append',index=False)
        result_1=result_[result_.date <= '2019-11-31']
        result_2=result_[result_.date > '2019-11-31']
        print(result_.head())
        result_1.to_sql(con=database_connection, name='toilet_paper_batch', if_exists='append',index=False)
        result_2.to_sql(con=database_connection, name='toilet_paper_batch', if_exists='append',index=False)
    except:
        print("check the toilet_paper_batch")
    #data_ass
    try:
        ...
        print("check the data assessment part")
db.close()
dbe.close()
#tlt_ass.to_csv('C:\\Users\\saravanan\\Desktop\\client_details_cleanliness_index_tlt_paper.csv',index=False)
#tlt_ass_dev.to_csv('C:\\Users\\saravanan\\Desktop\\client_details_cleanliness_index_tlt_paper_device.csv',index=False)
